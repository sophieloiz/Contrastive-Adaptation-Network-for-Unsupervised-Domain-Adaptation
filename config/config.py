...
__C.DATA_TRANSFORM.NORMALIZE_MEAN = 1  # 0.485
__C.DATA_TRANSFORM.NORMALIZE_STD = 0  # 0.229

# Training options
#
__C.TRAIN = edict()
# batch size setting
__C.TRAIN.SOURCE_BATCH_SIZE = 1  # 30
__C.TRAIN.TARGET_BATCH_SIZE = 1  # 30
__C.TRAIN.TARGET_CLASS_BATCH_SIZE = 1  # 3
__C.TRAIN.SOURCE_CLASS_BATCH_SIZE = 1  # 3
__C.TRAIN.NUM_SELECTED_CLASSES = 2  # 10
# model setting
...
__C.TRAIN.MIN_SN_PER_CLASS = 2  # 3
...
__C.CLUSTERING.TARGET_BATCH_SIZE = 1  # 100
__C.CLUSTERING.SOURCE_BATCH_SIZE = 1  # 100
